...
| 003 | 登录诊断增强 | P1 | ready | S | — | [spec](specs/003-login-diagnostics.md) |
| 004 | 日志详情页 | P1 | ready | M | — | [spec](specs/004-log-detail-page.md) |
| 005 | Keys UI 优化 | P2 | ready | S | 001 | [spec](specs/005-ui-polish-keys.md) |
| 006 | Auth UI 优化 | P2 | ready | S | 002 | [spec](specs/006-ui-polish-auth.md) |
