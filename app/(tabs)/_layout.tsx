...
import { ChartPie, FileText, KeyRound, Settings2, ShieldCheck, Users } from 'lucide-react-native';
...
export default function TabsLayout() {
  return (
    <Tabs screenOptions={{ headerShown: false, tabBarActiveTintColor: '#1d5f55', tabBarInactiveTintColor: '#8a8072' }}>
      ...
      <Tabs.Screen name="accounts" options={{ title: '账号', tabBarIcon: ({ color, size }) => <Users color={color} size={size} /> }} />
