  ...
  return (
    <Card className="rounded-[18px] bg-[#fbf8f2]">
      <Card.Body className="gap-2.5 p-4">
        <Card.Title className="text-lg font-bold text-[#16181a]">{title}</Card.Title>
        <Text selectable className="text-xs leading-5 text-[#6f665c]">{JSON.stringify(value, null, 2)}</Text>
      </Card.Body>
    </Card>
  );
}
