...
export default function MonitorScreen() {
  ...
  return (
    ...
    >
      {query.isLoading ? (
        <Card className="rounded-[24px] bg-[#fbf8f2]">
          <Card.Body className="items-center p-6">
            <Spinner color="#1d5f55" />
      ...
      {query.error ? (
        <Card className="rounded-[24px] border border-[#f3d9c8] bg-[#fbf1eb]">
      ...
      {query.data ? (
        <>
          ...
          <Card className="rounded-[24px] bg-[#fbf8f2]">
            <Card.Body className="p-4">
              <Card.Title className="text-lg font-bold text-[#16181a]">运行状态</Card.Title>
              <View className="mt-3">
                ...
                <DetailRow label="Usage Statistics" value={toBoolLabel(config['usage-statistics-enabled'])} isLast />
              </View>
            </Card.Body>
          </Card>
          ...
          <Card className="rounded-[24px] bg-[#fbf8f2]">
            <Card.Body className="p-4">
              <View className="flex-row items-center gap-2">
                ...
                <Card.Title className="text-lg font-bold text-[#16181a]">关键配置</Card.Title>
              </View>
              <View className="mt-3">
                ...
                <DetailRow label="API Keys" value={Array.isArray(config['api-keys']) ? String(config['api-keys'].length) : '0'} isLast />
              </View>
            </Card.Body>
          </Card>
        </>
